  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="pb-20">
      <form @submit.prevent="saveProfile" class="space-y-0">
        ...
        <div class="bg-white px-4 py-6 border-b border-gray-200">
          <div class="flex justify-center mb-4">
            <div class="relative">
              ...
              <label class="absolute bottom-0 right-0 bg-blue-600 text-white rounded-full p-2 cursor-pointer">
          ...
          <p class="text-center text-sm text-gray-500">プロフィール画像を選択</p>
        </div>
          ...
          <div class="flex gap-2">
            <button
              ...
              :class="[
                ...
                form.level === level.value ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'
              ]"
            >
              {{ level.label }}
            </button>
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              :class="[
                ...
                form.parts.includes(part.value) ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'
              ]"
              type="button"
            >
              {{ part.label }}
        ...
        <!-- 好きなジャンル -->
        <div class="bg-white px-4 py-4 border-b border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">好きなジャンル</label>
          <div class="flex flex-wrap gap-2">
            <button
              ...
              :class="[
                'px-4 py-2 rounded-full text-sm font-medium transition',
                form.genres.includes(genre.value) ? 'bg-red-500 text-white' : 'bg-gray-100 text-gray-700'
              ]"
              type="button"
            >
              {{ genre.label }}
        ...
        <!-- 音楽の好み -->
        <div class="bg-white px-4 py-4 border-b border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">音楽の好み</label>
          <div class="space-y-2">
            <div v-for="(preference, index) in form.music_preferences" :key="index" class="flex gap-2">
              <input
        ...
        <!-- コピーしたい曲 -->
        <div class="bg-white px-4 py-4 border-b border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">コピーしたい曲</label>
          <div class="space-y-2">
            <div v-for="(song, index) in form.songs_to_copy" :key="index" class="flex gap-2">
              <input
        ...
        <!-- 好きなアーティスト -->
        <div class="bg-white px-4 py-4 border-b border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">好きなアーティスト</label>
          <div class="space-y-2">
            <div v-for="(artist, index) in form.favorite_artists" :key="index" class="flex gap-2">
              <input
        ...
        <!-- こんな人とバンド組みたい -->
        <div class="bg-white px-4 py-4 border-b border-gray-200">
          <label class="block text-sm font-medium text-gray-700 mb-2">こんな人とバンド組みたい</label>
          <textarea
